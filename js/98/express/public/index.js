...
(function () {
    ...
    const canvas = document.getElementById('theCanvas'), intervalLength = 16.66,
    ...
    const aboveCanvas = 550;//window.innerHeight - canvas.height ;
        ...
        fight() {
            Ant.ants.forEach(a => {
                if (a.x === this.x && a.y === this.y && a.color !== this.color && !this.fighting) {
                    ...
                    fight.style.top = `${this.y + aboveCanvas}px`; fight.style.left = `${this.x}px`;
                ...
                if (this.x === ant.x && this.y === ant.y && !this.isHome && !ant.goingHome) {
                    ...
                    let intervalId = setInterval(() => {
                        ...
                        if (ant.x > (theHomeX - discrepancy) && ant.x < (theHomeX + discrepancy) && ant.y > (theHomeY - discrepancy) && ant.y < (theHomeY + discrepancy)) {
                            ...
                            eaten.style.top = `${this.y + aboveCanvas }px`; eaten.style.left = `${this.x}px`;
